    ...
    def plot(
        ...
        if grid is not False:
            ...
            if mode == "lower":
                ...
                plt.axvline(
                    width - 0.5, ymin=0, ymax=1.0 / width, color="grey", lw=2
                )
            ...
            # can probably be simplified
                ...
                plt.axvline(
                    -0.5, ymin=1 - 1.0 / width, ymax=1, color="grey", lw=2
                )
        ...
        for x in range(width):
            for y in range(height):
                ...
                if method in ["ellipse", "square", "rectangle", "color"]:
                    ...
                    # Initialize `matplotlib.colors.Normalize()` object as 
                    # `color_normalizer`
                    ...
                    # Select colors for each `d` with normalized colormap
                    edgecolor = self.cm(
                        color_normalizer(d))
